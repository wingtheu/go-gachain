...
import (
	...
	"github.com/GACHAIN/go-gachain/tools/desync_monitor/config"
	"github.com/GACHAIN/go-gachain/tools/desync_monitor/query"
...
var alertMessageTo *string = flag.String(alertMessageToFlagName, "support@block.vc", "email adress to send alert")
...
var alertMessageFrom *string = flag.String(alertMessageFromFlagName, "support@block.vc", "email adress from witch to send alert")
